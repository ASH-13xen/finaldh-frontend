                ...
                >
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      {downloadedCount > 0 && (
                        <div className="mt-2.5 bg-indigo-950/20 border border-indigo-900/30 rounded-xl p-2.5 text-[10px] text-indigo-300 flex items-start gap-2 font-medium">
                          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-3.5 h-3.5 text-indigo-400 flex-shrink-0 mt-0.5"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                          <span>PDF is locked. Open password is your registered email: <span className="text-white font-bold select-all">{currentUser?.email}</span></span>
                        </div>
                      )}
                    </div>
                  </div>
